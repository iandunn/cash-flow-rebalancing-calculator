...
It's a simple interactive web page, so [you can use it right now](https://iandunn.github.io/cash-flow-rebalancing-calculator/). [link currently broken] 

Instructions are in the calculator itself, so that they're easy to access while using it. [Open the calculator](https://iandunn.github.io/cash-flow-rebalancing-calculator/) to read them. [link currently broken]
